...
class DishesControllerTest < ActionController::TestCase
  ...
  test "should create dish" do
    assert_difference('Dish.count') do
      post :create, dish: { grams: @dish.grams, ingredients: @dish.ingredients, price: @dish.price, time: @dish.time }
    end
  ...
  test "should update dish" do
    put :update, id: @dish, dish: { grams: @dish.grams, ingredients: @dish.ingredients, price: @dish.price, time: @dish.time }
    assert_redirected_to dish_path(assigns(:dish))
  end
